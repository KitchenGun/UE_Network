...
AUE5NetworkStudyCharacter::AUE5NetworkStudyCharacter()
{
...
void AUE5NetworkStudyCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUE5NetworkStudyCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUE5NetworkStudyCharacter::Look);
	}
	else
	{
...
void AUE5NetworkStudyCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUE5NetworkStudyCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
